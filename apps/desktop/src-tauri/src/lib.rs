...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings_get_agent_service_name,
            commands::settings_set_agent_service_name,
            ...
            agent::agent_get_google_calendar_settings,
            agent::agent_update_google_calendar_settings,
            agent::agent_test_google_calendar,
            agent::agent_list_calendar_drafts,
            agent::agent_update_calendar_draft,
